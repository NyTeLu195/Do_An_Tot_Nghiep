...
namespace EduManage.Core.Domain.Specification
{
    /// <summary>
    /// Class SpecificationBase.
    /// </summary>
    /// <typeparam name="T"></typeparam>
    /// <seealso cref="VNR.Core.Domain.Specification.ISpecification{T}" />
    public abstract class SpecificationBase<T> : ISpecification<T>
    {
        ...
        protected SpecificationBase(Expression<Func<T, bool>> criteria, List<Expression<Func<T, object>>> includes)
        {
            Criteria = criteria;
            Includes = includes;
        }
